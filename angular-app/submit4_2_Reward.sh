...
index=1
	...
	curl -X POST --header 'Content-Type: application/json' \
			...
			-d '{
				...
				"coinsDec": "resource:org.decentralized.energy.network.Coins#CO_0104",
				"targetCompany": "resource:org.decentralized.energy.network.TargetCompany#0104"
			}' \
	...
	curl -X POST --header 'Content-Type: application/json' \
			...
			-d '{
				"$class": "org.decentralized.energy.network.DistributeCoins",
				"coinsInc": "resource:org.decentralized.energy.network.Coins#CO_2",
				"coinsDec": "resource:org.decentralized.energy.network.Coins#CO_0105",
				"targetCompany": "resource:org.decentralized.energy.network.TargetCompany#0105"
			}' \
			'http://localhost:3000/api/DistributeCoins'
	curl -X POST --header 'Content-Type: application/json' \
			--header 'Accept: application/json'  \
			-d '{
				"$class": "org.decentralized.energy.network.DistributeCoins",
				"coinsInc": "resource:org.decentralized.energy.network.Coins#CO_2",
				"coinsDec": "resource:org.decentralized.energy.network.Coins#CO_0106",
				"targetCompany": "resource:org.decentralized.energy.network.TargetCompany#0106"
			}' \
			'http://localhost:3000/api/DistributeCoins'
