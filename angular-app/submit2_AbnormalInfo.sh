...
curl -X POST --header 'Content-Type: application/json' --header 'Accept: application/json'  \
    ...
    "ownerID": "2", "ownerEntity": "Resident","description":"udp data abnormal","flag":"0"}' \
...
# curl -X POST --header 'Content-Type: application/json' --header 'Accept: application/json'  \
#     -d '{"$class": "org.decentralized.energy.network.Energy",
#     "energyID": "6", "targetIP": "192.168.1.1", "value": "'"$(date +'%s')"'",
#     "ownerID": "3", "ownerEntity": "Resident","description":"DNS flood","flag":"0"}' \
#     'http://localhost:3000/api/Energy'
#
# curl -X POST --header 'Content-Type: application/json' --header 'Accept: application/json'  \
#     -d '{"$class": "org.decentralized.energy.network.Energy",
#     "energyID": "7", "targetIP": "192.168.1.1", "value": "'"$(date +'%s')"'",
#     "ownerID": "1", "ownerEntity": "Resident","description":"DNS flood","flag":"0"}' \
#     'http://localhost:3000/api/Energy'
