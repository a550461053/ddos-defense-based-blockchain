...
function EnergyToDDoS(UpdateValues) {
    ...
    //     if (!(energy_list[i].units.value in energy_object_dict)){
    //       energy_object_dict[energy_list[i].units.value] = 1;
    //     }else{
    //       energy_object_dict[energy_list[i].units.value] += 1;
    //     }
    // }
    ...
    UpdateValues.energyInc.value = UpdateValues.energyInc.value + 10;
    UpdateValues.energyDec.value = UpdateValues.energyDec.value; // - UpdateValues.energyValue;
