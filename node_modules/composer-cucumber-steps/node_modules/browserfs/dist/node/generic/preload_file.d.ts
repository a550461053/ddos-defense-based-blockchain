...
export default class PreloadFile<T extends FileSystem> extends BaseFile {
     ...
     */
    write(buffer: Buffer, offset: number, length: number, position: number, cb: (e: ApiError, len?: number, buff?: Buffer) => void): void;
    /**
     * Write buffer to the file.
     ...
     */
    read(buffer: Buffer, offset: number, length: number, position: number, cb: (e: ApiError, len?: number, buff?: Buffer) => void): void;
    /**
     * Read data from the file.
     * @param [BrowserFS.node.Buffer] buffer The buffer that the data will be
     *   written to.
