module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c428 = function(qualifiedName, instanceId) {
          return {
            type: "Binding",
        ...
        peg$c429 = function(qualifiedName) {
          return {
        ...
        peg$c435 = "READ",
        peg$c436 = { type: "literal", value: "READ", description: "\"READ\"" },
        peg$c437 = "UPDATE",
        peg$c438 = { type: "literal", value: "UPDATE", description: "\"UPDATE\"" },
        peg$c439 = "DELETE",
        peg$c440 = { type: "literal", value: "DELETE", description: "\"DELETE\"" },
        peg$c441 = function(verb) {
            return verb
        },
        peg$c442 = function(first, others) {
            return [first].concat(others);
        },
        peg$c443 = "ALL",
        peg$c444 = { type: "literal", value: "ALL", description: "\"ALL\"" },
        peg$c445 = function() {
            return ['ALL']
        },
        peg$c446 = "ANY",
        peg$c447 = { type: "literal", value: "ANY", description: "\"ANY\"" },
        peg$c448 = function(test) {
             return test;
           },
        peg$c449 = "ALLOW",
        peg$c450 = { type: "literal", value: "ALLOW", description: "\"ALLOW\"" },
        peg$c451 = "DENY",
        peg$c452 = { type: "literal", value: "DENY", description: "\"DENY\"" },
        peg$c453 = function(chars) {
                return chars.join("");
              },
        peg$c454 = "transaction:",
        peg$c455 = { type: "literal", value: "transaction:", description: "\"transaction:\"" },
        peg$c456 = function(binding) {
            return {
                binding: binding
            };
        },
        peg$c457 = function(variableBinding, binding) {
            return {
    ...
    function peg$parseBindingRootRecursive() {
      var s0, s1;
    ...
    function peg$parseNoun() {
      ...
      s0 = peg$parseBinding();
      if (s0 === peg$FAILED) {
        s0 = peg$parseBindingNoInstance();
        if (s0 === peg$FAILED) {
          s0 = peg$parseBindingRootRecursive();
        }
      }
