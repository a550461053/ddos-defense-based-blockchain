module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$startRuleFunctions = { Start: peg$parseStart, SelectStatement: peg$parseSelectStatement },
        ...
        peg$c270 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c271 = "*",
        ...
        peg$c313 = "AND",
        peg$c314 = { type: "literal", value: "AND", description: "\"AND\"" },
        peg$c315 = "OR",
        peg$c316 = { type: "literal", value: "OR", description: "\"OR\"" },
        peg$c317 = "CONTAINS",
        peg$c318 = { type: "literal", value: "CONTAINS", description: "\"CONTAINS\"" },
        peg$c319 = "?",
        ...
        peg$c348 = function(first, rest) { return buildList(first, rest, 1); },
        ...
        peg$c383 = function(statementList) {
              return {
                type: "FunctionBody",
        ...
        peg$c384 = "validator",
        peg$c385 = { type: "literal", value: "validator", description: "\"validator\"" },
        peg$c386 = function(validator) {
              return {
                type: "Validator",
                text: validator
              };
        ...
        peg$c387 = "optional",
        peg$c388 = { type: "literal", value: "optional", description: "\"optional\"" },
        peg$c389 = function() {
              return {
                type: "Optional"
              };
            },
        peg$c390 = function(def) {
              return {
                type: "Default",
                text: def
              };
        ...
        peg$c392 = "query",
        peg$c393 = { type: "literal", value: "query", description: "\"query\"" },
        peg$c394 = "SELECT",
        peg$c395 = { type: "literal", value: "SELECT", description: "\"SELECT\"" },
        peg$c396 = "FROM",
        peg$c397 = { type: "literal", value: "FROM", description: "\"FROM\"" },
        peg$c398 = "WHERE",
        peg$c399 = { type: "literal", value: "WHERE", description: "\"WHERE\"" },
        peg$c400 = "ORDER BY",
        peg$c401 = { type: "literal", value: "ORDER BY", description: "\"ORDER BY\"" },
        peg$c402 = "SKIP",
        peg$c403 = { type: "literal", value: "SKIP", description: "\"SKIP\"" },
        peg$c404 = "LIMIT",
        peg$c405 = { type: "literal", value: "LIMIT", description: "\"LIMIT\"" },
        peg$c406 = "ASC",
        peg$c407 = { type: "literal", value: "ASC", description: "\"ASC\"" },
        peg$c408 = "DESC",
        peg$c409 = { type: "literal", value: "DESC", description: "\"DESC\"" },
        peg$c410 = function(queries) {
            return {
              type: "Queries",
              queries: queries
            };
          },
        peg$c411 = "description:",
        peg$c412 = { type: "literal", value: "description:", description: "\"description:\"" },
        peg$c413 = "statement:",
        peg$c414 = { type: "literal", value: "statement:", description: "\"statement:\"" },
        peg$c415 = function(id, description, select) {
            return {
              type: "Query",
              identifier: id,
        ...
        peg$c416 = function(resource, from, registry, where, orderBy, limit, skip) {
            return {
              type: "SELECT FROM",
              resource: resource,
              registry: registry,
        ...
        peg$c417 = function(resource, where, orderBy, limit, skip) {
            return {
              type: "SELECT",
              resource: resource,
              where: where,
        ...
        peg$c418 = function(limit) {
            return limit;
          },
        peg$c419 = function(limit) {
            return { type: "Literal", value: parseInt(limit) };
          },
        peg$c420 = function(skip) {
            return skip;
          },
        peg$c421 = function(skip) {
            return { type: "Literal", value: parseInt(skip) };
          },
        peg$c422 = function() { return "ASC"; },
        peg$c423 = function() { return "DESC"; },
        peg$c424 = function(sort) {
            return {
              sort: sort,
            };
          },
        peg$c425 = function(sort) {
             return [sort]
         },
        peg$c426 = function(first, rest) {
            return [first].concat(rest);
          },
        peg$c427 = function(item) {
            return item;
          },
        peg$c428 = function(fieldName, direction) {
            return {
              fieldName: fieldName,
              direction: direction
            };
          },
        peg$c429 = function(test) {
             return test;
           },
        ...
        peg$c438 = "_$",
        peg$c439 = { type: "literal", value: "_$", description: "\"_$\"" },
    ...
    function peg$parseSelectStatement() {
      ...
      s0 = peg$parseFromSelectStatement();
      if (s0 === peg$FAILED) {
        s0 = peg$parseSimpleSelectStatement();
      }

      return s0;
    }

    function peg$parseFromSelectStatement() {
                              ...
                              if (s13 !== peg$FAILED) {
                                ...
                                if (s14 !== peg$FAILED) {
                                  ...
                                  if (s15 !== peg$FAILED) {
                                    ...
                                    if (s16 !== peg$FAILED) {
                                      peg$savedPos = s0;
                                      s1 = peg$c416(s4, s6, s8, s10, s12, s14, s16);
                                      s0 = s1;
                                    } else {
                                      peg$currPos = s0;
                                      s0 = peg$FAILED;
    ...
    function peg$parseSimpleSelectStatement() {
    ...
    function peg$parseLimit() {
      ...
      s0 = peg$parseLimitParameter();
      if (s0 === peg$FAILED) {
        s0 = peg$parseLimitLiteral();
      }

      return s0;
    }

    function peg$parseLimitParameter() {
      var s0, s1, s2, s3;
    ...
    function peg$parseLimitLiteral() {
      var s0, s1, s2, s3, s4;
    ...
    function peg$parseSkip() {
      ...
      s0 = peg$parseSkipParameter();
      if (s0 === peg$FAILED) {
        s0 = peg$parseSkipLiteral();
      }

      return s0;
    }

    function peg$parseSkipParameter() {
      var s0, s1, s2, s3;
    ...
    function peg$parseSort() {
      ...
      s0 = s1;
      if (s0 === peg$FAILED) {
        s0 = peg$parseSortArray();
      }

      return s0;
    }

    function peg$parseSortArray() {
      var s0, s1, s2, s3, s4, s5, s6, s7;
      ...
      if (s1 !== peg$FAILED) {
        ...
        if (s2 !== peg$FAILED) {
          s3 = peg$parse_();
          if (s3 !== peg$FAILED) {
            s4 = peg$parseSortSingleField();
            if (s4 !== peg$FAILED) {
              s5 = peg$parse_();
              if (s5 !== peg$FAILED) {
                s6 = [];
                s7 = peg$parseSortRest();
                while (s7 !== peg$FAILED) {
                  s6.push(s7);
                  s7 = peg$parseSortRest();
                }
    ...
    function peg$parseSortSingleField() {
      var s0, s1, s2, s3, s4;
